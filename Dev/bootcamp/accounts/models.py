...
class CustomUser(AbstractUser):
    '''
    ===========================================================
    This class represents the user object outlined in the db
    ===========================================================
    Attrs:
        :param id: = models.AutoField()
        :param email: email field
        :type email: str max_length = None
        :param username: nickname field
        :type username: str max_length = 200
        :param password: hidden input password field
        :type password: str max_length = 200
    ...
    ..note::
        logging here is implemented via catching
        errors and set to logger as a variable
    '''
    ...
    def to_dict(self):
        '''
        :returns: user email, user password, user username,
    ...
    def user_exists(data):
        ...
        :returns: True if user exists, False if opposite
